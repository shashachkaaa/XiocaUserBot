...
async def update(client, message):
	...
	if ver == v:
		...
		connect.commit()
		subprocess.run("rm -rf bull_text.py", shell=True, capture_output=True)
		subprocess.run("rm -rf requirements.txt", shell=True, capture_output=True)
		subprocess.run("rm -rf main.py", shell=True, capture_output=True)
